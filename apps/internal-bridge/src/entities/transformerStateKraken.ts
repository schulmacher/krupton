...
export const createKrakenOrderBookTransformerStateStorage = (
  baseDir: string,
...
export const createKrakenApiTradeTransformerStateStorage = (
  baseDir: string,
  options: { writable: boolean },
) => {
...
export const createKrakenWsTradeTransformerStateStorage = (
  baseDir: string,
  options: { writable: boolean },
) => {
