...
import { createExternalBridgeFetcherRateLimiter } from './externalBridgeFetcherRateLimiter.js';

describe('createExternalBridgeFetcherRateLimiter', () => {
  ...
  describe('recordRequest', () => {
    it('should increment request count', async () => {
      const rateLimiter = createExternalBridgeFetcherRateLimiter(mockDiagnosticContext, {
        maxRequests: 10,
        windowMs: 1000,
      });
